...
public class WaterJetCentralBlockEntity extends ExtraLightsLightBlockEntity
        implements HasJetHeight, HasJetThickness {

    public double smoothedHeight = 0.0;
    private float jetHeight = 15.0f;
    private float jetThickness = 0.4f;
    ...
    public WaterJetCentralBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.WATER_JET_CENTRAL.get(), pos, state);
        setChannelCount(1);
    }
    ...
    public static void tick(net.minecraft.world.level.Level level, net.minecraft.core.BlockPos pos,
                            net.minecraft.world.level.block.state.BlockState state, WaterJetCentralBlockEntity blockEntity) {
        if (level.isClientSide()) {
            com.github.dumann089.theatricalextralights.client.WaterJetClientEffects.tickJet(
                    blockEntity,
                    com.github.dumann089.theatricalextralights.client.WaterJetClientEffects.CENTRAL,
    ...
    public Fixture getFixture() {
        return Fixtures.WATER_JET_CENTRAL.get();
    }
    ...
    public String getModelName() {
        return "Water Jet Central";
    }

    @Override
    public ResourceLocation getFixtureId() {
        return Fixtures.WATER_JET_CENTRAL.getId();
    }
    ...
    public String getTranslationKey() {
        return "block.theatricalextralights.water_jet_central";
    }
}
