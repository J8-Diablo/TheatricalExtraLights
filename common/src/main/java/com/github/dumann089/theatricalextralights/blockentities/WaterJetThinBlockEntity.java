...
public class WaterJetThinBlockEntity extends ExtraLightsLightBlockEntity
    ...
    public WaterJetThinBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.WATER_JET_THIN.get(), pos, state);
        setChannelCount(1);
    }
    ...
    public static void tick(net.minecraft.world.level.Level level, net.minecraft.core.BlockPos pos,
                            net.minecraft.world.level.block.state.BlockState state, WaterJetThinBlockEntity blockEntity) {
        if (level.isClientSide()) {
            com.github.dumann089.theatricalextralights.client.WaterJetClientEffects.tickJet(
                    blockEntity,
                    com.github.dumann089.theatricalextralights.client.WaterJetClientEffects.THIN,
    ...
    public Fixture getFixture() {
        return Fixtures.WATER_JET_THIN.get();
    }
    ...
    public String getModelName() {
        return "Water Jet Thin";
    }

    @Override
    public ResourceLocation getFixtureId() {
        return Fixtures.WATER_JET_THIN.getId();
    }
    ...
    public String getTranslationKey() {
        return "block.theatricalextralights.water_jet_thin";
    }
}
