...
public class Par1000OrangeRenderer extends FixtureRenderer<Par1000OrangeBlockEntity> {
    ...
    @Override
    public void beforeRenderBeam(Par1000OrangeBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
