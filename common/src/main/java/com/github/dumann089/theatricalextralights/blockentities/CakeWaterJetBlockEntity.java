...
public class CakeWaterJetBlockEntity extends ExtraLightsLightBlockEntity
    ...
    public CakeWaterJetBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.CAKE_WATER_JET.get(), pos, state);
        setChannelCount(1);
    }
    // -------------------
    // GETTERS / SETTERS
    ...
    public Fixture getFixture() {
        return Fixtures.CAKE_WATER_JET.get();
    }
    ...
    public String getModelName() {
        return "Cake Water Jet";
    }

    @Override
    public ResourceLocation getFixtureId() {
        return Fixtures.CAKE_WATER_JET.getId();
    }
    ...
    public String getTranslationKey() {
        return "block.theatricalextralights.CakeWaterJet";
    }
}