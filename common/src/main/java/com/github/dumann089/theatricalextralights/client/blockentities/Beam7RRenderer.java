...
public class Beam7RRenderer extends FixtureRenderer<Beam7RBlockEntity> {
    ...
    @Override
    public void beforeRenderBeam(Beam7RBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
...
//            poseStack.translate(blockEntity.getFixture().getBeamStartPosition()[0], blockEntity.getFixture().getBeamStartPosition()[1], blockEntity.getFixture().getBeamStartPosition()[2]);
                    ...
                    addVertex(beamConsumer, m, normal, r, g, b, a, -0.1875f, 0.15625f , 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,  0.1875f, 0.15625f, 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a, 0.1875f, -0.15625f,0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,-0.1875f, -0.15625f, 0f);
                    poseStack.popPose();
