...
public class Moving500Fixture extends Fixture {
    ...
    private static final ResourceLocation TILT_MODEL = new ResourceLocation(TheatricalExtraLights.MOD_ID, "block/moving500/moving500_tilt");
    private static final ResourceLocation PAN_MODEL = new ResourceLocation(TheatricalExtraLights.MOD_ID, "block/moving500/moving500_pan");
    private static final ResourceLocation STATIC_MODEL = new ResourceLocation(TheatricalExtraLights.MOD_ID, "block/moving500/moving500_static");

    private final float[] tiltRotation = new float[]{0.5F, 0.78F, .506F};
    private final float[] panRotation = new float[]{0.5F, 0.193F, .5F};
