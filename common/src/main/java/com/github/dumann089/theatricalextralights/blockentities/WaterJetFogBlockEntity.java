...
public class WaterJetFogBlockEntity extends ExtraLightsLightBlockEntity
    ...
    public WaterJetFogBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.WATER_JET_FOG.get(), pos, state);
        setChannelCount(1);
    }
    ...
    public Fixture getFixture() {
        return Fixtures.WATER_JET_FOG.get();
    }
    ...
    public String getModelName() {
        return "Water Jet Fog";
    }

    @Override
    public ResourceLocation getFixtureId() {
        return Fixtures.WATER_JET_FOG.getId();
    }
