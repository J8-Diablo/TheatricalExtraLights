...
public class WaterJet15mBlockEntity extends BaseDMXConsumerLightBlockEntity {

    public double smoothedHeight = 0.0;
    private int tickCounter = 0;

    public WaterJet15mBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.WATER_JET15M.get(), pos, state);
        setChannelCount(1);
    }

    @Override
    public Fixture getFixture() {
        return Fixtures.WATER_JET15M.get();
    }
    ...
    public String getModelName() {
        return "Water Jet 15m";
    }

    @Override
    public ResourceLocation getFixtureId() {
        return Fixtures.WATER_JET15M.getId();
    }
    ...
    public String getTranslationKey() {
        return "block.theatricalextralights.water_jet15m";
    }
}
