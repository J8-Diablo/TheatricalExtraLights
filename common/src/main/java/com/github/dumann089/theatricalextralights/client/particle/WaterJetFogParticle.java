...
public class WaterJetFogParticle extends TextureSheetParticle {
    ...
    protected WaterJetFogParticle(
        ...
        this.lifetime = 65 + random.nextInt(25);
        this.gravity = 0.45F;
        this.hasPhysics = false;

        float t = Mth.clamp(coneAngleDeg / 90f, 0f, 1f);
        ...
        float totalSpeed = intensity * 0.2f;
