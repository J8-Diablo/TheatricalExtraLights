...
public class WaterJet5mBlockEntity extends BaseDMXConsumerLightBlockEntity {

    public double smoothedHeight = 0.0;
    private int tickCounter = 0;

    public WaterJet5mBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.WATER_JET5M.get(), pos, state);
        setChannelCount(1);
    }

    @Override
    public Fixture getFixture() {
        return Fixtures.WATER_JET5M.get();
    }
    ...
    public ResourceLocation getFixtureId() {
        return Fixtures.WATER_JET5M.getId();
    }
    ...
    public void tick() {
        ...
        if (tickCounter % 8 == 0) {
            level.addAlwaysVisibleParticle(
                    ModParticle.WATERJET2PARTICLE.get(),
                    true,
    ...
    public String getTranslationKey() {
        return "block.theatricalextralights.water_jet5m";
    }
}
