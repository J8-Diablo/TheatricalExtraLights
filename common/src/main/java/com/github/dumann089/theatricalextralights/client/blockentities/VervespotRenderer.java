...
public class VervespotRenderer extends ExtraLightsFixtureRenderer<VervespotBlockEntity> {
    ...
    public void beforeRenderBeam(
            VervespotBlockEntity blockEntity,
            PoseStack poseStack,
                ...
                public void render(MultiBufferSource.BufferSource bufferSource, PoseStack poseStack, Camera camera, float partialTick) {
                    ...
                    if (goboValue == 0) {
                        if (TheatricalExtraLightsConfig.shouldRender2DBeam()) {
                            ...
                            renderLightBeam2D(builder, poseStack, blockEntity, camera, alpha, 0.10f, (float) blockEntity.getDistance(), color, 0.007f);
                            poseStack.popPose();
                        } else {
                            poseStack.pushPose();
                            poseStack.translate(0.5f, 1.225f, -0.38f);
                            renderLightBeam4D(builder, poseStack, blockEntity, partialTick, alpha, 0.10f, (float) blockEntity.getDistance(), color, 0.007f);
                            poseStack.popPose();
                        }
                    }
                    ...
                    // LENS
                    renderLens(multiBufferSource, poseStack, alpha, color, 0.22f, 0.5f, 1.225f, -0.38f);
