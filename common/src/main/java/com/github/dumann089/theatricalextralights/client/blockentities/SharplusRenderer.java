...
public class SharplusRenderer extends ExtraLightsFixtureRenderer<SharplusBlockEntity> {
    ...
    public void beforeRenderBeam(
            SharplusBlockEntity blockEntity,
            PoseStack poseStack,
                ...
                public void render(MultiBufferSource.BufferSource bufferSource, PoseStack poseStack, Camera camera, float partialTick) {
                    ...
                    if (goboValue == 0) {
                        if (TheatricalExtraLightsConfig.shouldRender2DBeam()) {
                            ...
                            renderLightBeam2D(builder, poseStack, blockEntity, camera, alpha, 0.07f, (float) blockEntity.getDistance(), color, 0.007f);
                            poseStack.popPose();
                        } else {
                            poseStack.pushPose();
                            poseStack.translate(0.5f, 0.804f, 0.148f);
                            renderLightBeam4D(builder, poseStack, blockEntity, partialTick, alpha, 0.07f, (float) blockEntity.getDistance(), color, 0.007f);
                            poseStack.popPose();
                        }
                    }
                    ...
                    // LENS
                    renderLens(multiBufferSource, poseStack, alpha, color, 0.1f, 0.5f, 0.78125f, 0.14f);
