...
public class FanWaterJetBlockEntity extends ExtraLightsLightBlockEntity
    ...
    public FanWaterJetBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.FAN_WATER_JET.get(), pos, state);
        setChannelCount(1);
    }
    // -------------------
    // GETTERS / SETTERS
    ...
    public Fixture getFixture() {
        return Fixtures.FAN_WATER_JET.get();
    }
    ...
    public String getModelName() {
        return "Fan Water Jet";
    }

    @Override
    public ResourceLocation getFixtureId() {
        return Fixtures.FAN_WATER_JET.getId();
    }
    ...
    public String getTranslationKey() {
        return "block.theatricalextralights.FanWaterJet";
    }
}