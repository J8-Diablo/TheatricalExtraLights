...
public class VaseWaterJetBlockEntity extends ExtraLightsLightBlockEntity
    ...
    public VaseWaterJetBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.VASE_WATER_JET.get(), pos, state);
        setChannelCount(1);
    }
    // -------------------
    // GETTERS / SETTERS
    ...
    public Fixture getFixture() {
        return Fixtures.VASE_WATER_JET.get();
    }
    ...
    public ResourceLocation getFixtureId() {
        return Fixtures.VASE_WATER_JET.getId();
    }
    ...
    public String getTranslationKey() {
        return "block.theatricalextralights.VaseWaterJet";
    }
}