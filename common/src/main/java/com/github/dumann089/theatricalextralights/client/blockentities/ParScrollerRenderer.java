...
public class ParScrollerRenderer extends FixtureRenderer<ParScrollerBlockEntity> {
    ...
    @Override
    public void beforeRenderBeam(ParScrollerBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
...
//            poseStack.translate(blockEntity.getFixture().getBeamStartPosition()[0], blockEntity.getFixture().getBeamStartPosition()[1], blockEntity.getFixture().getBeamStartPosition()[2]);
                    ...
                    poseStack.translate(0.5, 0.56f, 0.0390f);
