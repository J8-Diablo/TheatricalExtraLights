...
public class OrganPipesBlockEntity extends ExtraLightsLightBlockEntity
    ...
    public OrganPipesBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.ORGANPIPES.get(), pos, state);
        setChannelCount(1);
    }
    ...
    public static void tick(net.minecraft.world.level.Level level, net.minecraft.core.BlockPos pos,
                            net.minecraft.world.level.block.state.BlockState state, OrganPipesBlockEntity blockEntity) {
        if (level.isClientSide()) {
            com.github.dumann089.theatricalextralights.client.WaterJetClientEffects.tickOrganPipes(
                    blockEntity,
    ...
    public Fixture getFixture() {
        return Fixtures.ORGANPIPES.get();
    }
    ...
    public ResourceLocation getFixtureId() {
        return Fixtures.ORGANPIPES.getId();
    }
    ...
    public String getTranslationKey() {
        return "block.theatricalextralights.organpipes";
    }
}