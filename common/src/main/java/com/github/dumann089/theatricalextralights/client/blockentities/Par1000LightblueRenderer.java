...
public class Par1000LightblueRenderer extends FixtureRenderer<Par1000LightblueBlockEntity> {
    ...
    @Override
    public void beforeRenderBeam(Par1000LightblueBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
