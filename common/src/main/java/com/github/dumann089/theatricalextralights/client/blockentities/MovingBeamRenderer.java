...
public class MovingBeamRenderer extends ExtraLightsFixtureRenderer<MovingBeamBlockEntity> {
    ...
    public void beforeRenderBeam(
            MovingBeamBlockEntity blockEntity,
            PoseStack poseStack,
                ...
                public void render(MultiBufferSource.BufferSource bufferSource, PoseStack poseStack, Camera camera, float partialTick) {
                    ...
                    if (goboValue == 0) {
                        if (TheatricalExtraLightsConfig.shouldRender2DBeam()) {
                            ...
                            renderLightBeam2D(builder, poseStack, blockEntity, camera, alpha, 0.07f, (float) blockEntity.getDistance(), color, 0.002f);
                            poseStack.popPose();
                        } else {
                            poseStack.pushPose();
                            poseStack.translate(0.5f, 0.781f, 0.2f);
                            renderLightBeam4D(builder, poseStack, blockEntity, partialTick, alpha, 0.07f, (float) blockEntity.getDistance(), color, 0.002f);
                            poseStack.popPose();
                        }
                    }
