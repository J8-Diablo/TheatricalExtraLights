...
public class MovingBeamRenderer extends FixtureRenderer<MovingBeamBlockEntity> {
    ...
    @Override
    public void beforeRenderBeam(MovingBeamBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
