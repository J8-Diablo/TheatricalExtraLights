...
public class Par1000GreenFixture extends Fixture {
    ...
    private static final ResourceLocation TILT_MODEL = new ResourceLocation(TheatricalExtraLights.MOD_ID, "block/par1000/par1000_green");
