...
public class OrganPipesInvBlockEntity extends ExtraLightsLightBlockEntity
    ...
    public OrganPipesInvBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.ORGANPIPES_INV.get(), pos, state);
        setChannelCount(1);
    }
    ...
    public static void tick(net.minecraft.world.level.Level level, net.minecraft.core.BlockPos pos,
                            net.minecraft.world.level.block.state.BlockState state, OrganPipesInvBlockEntity blockEntity) {
        if (level.isClientSide()) {
            com.github.dumann089.theatricalextralights.client.WaterJetClientEffects.tickOrganPipesInv(
                    blockEntity,
                    com.github.dumann089.theatricalextralights.client.particle.JetVariant.JET3,
    ...
    public Fixture getFixture() {
        return Fixtures.ORGANPIPES_INV.get();
    }
    ...
    public String getModelName() {
        return "Organ Pipes Inv";
    }

    @Override
    public ResourceLocation getFixtureId() {
        return Fixtures.ORGANPIPES_INV.getId();
    }
    ...
    public String getTranslationKey() {
        return "block.theatricalextralights.organpipes_inv";
    }
}