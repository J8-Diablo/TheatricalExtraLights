...
public class a2x2par64_magentaFixture extends Fixture {
    ...
    private static final ResourceLocation TILT_MODEL = new ResourceLocation(TheatricalExtraLights.MOD_ID, "block/partruss/2x2/2x2par64_magenta_whole");
