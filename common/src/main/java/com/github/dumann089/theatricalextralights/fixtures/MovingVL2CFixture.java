...
public class MovingVL2CFixture extends Fixture {
    ...
    private final float[] tiltRotation = new float[]{0.5F, 0.8125F, .5F};
    private final float[] panRotation  = new float[]{0.5F, 0.8125F, .5F};

    @Override public ResourceLocation getTiltModel()            { return TILT_MODEL; }
    @Override public ResourceLocation getPanModel()             { return PAN_MODEL; }
    @Override public ResourceLocation getStaticModel()          { return STATIC_MODEL; }
    @Override public float[] getTiltRotationPosition()          { return tiltRotation; }
    @Override public float[] getPanRotationPosition()           { return panRotation; }
    @Override public float[] getBeamStartPosition()             { return new float[]{0.5F, 0.8125F, 0.01F}; }
    @Override public float getDefaultRotation()                 { return 90; }
    @Override public float getBeamWidth()                       { return 0.00f; }
    @Override public float getRayTraceRotation()                { return 0; }
    @Override public HangType getHangType()                     { return HangType.BRACE_BAR; }
    @Override public double getLightRadius()                     { return 8.0; }
    @Override public List<DMXPersonality> getDMXPersonalities() { return PERSONALITIES; }
