...
public class MovingVL2CBeamsRenderer extends ExtraLightsFixtureRenderer<MovingVL2CBeamsBlockEntity> {
    ...
    // Instancia del renderizador volumétrico (compartido porque cachea por Hash)
// Cada fixture tiene su propio caché volumétrico para evitar que se sobrescriban entre sí
