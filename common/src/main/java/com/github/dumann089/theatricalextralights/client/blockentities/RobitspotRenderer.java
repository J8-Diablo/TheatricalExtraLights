...
public class RobitspotRenderer extends FixtureRenderer<RobitspotBlockEntity> {
    ...
    @Override
    public void beforeRenderBeam(RobitspotBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
...
//            poseStack.translate(blockEntity.getFixture().getBeamStartPosition()[0], blockEntity.getFixture().getBeamStartPosition()[1], blockEntity.getFixture().getBeamStartPosition()[2]);
                    ...
                    poseStack.translate(0.5F, 1.455F, -0.59F);
                    Matrix4f m = poseStack.last().pose();
                    Matrix3f normal = poseStack.last().normal();
                    addVertex(beamConsumer, m, normal, r, g, b, a, -0.21875f, 0.21875f , 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,  0.21875f, 0.21875f, 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a, 0.21875f, -0.21875f,0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,-0.21875f, -0.21875f, 0f);
                    poseStack.popPose();
