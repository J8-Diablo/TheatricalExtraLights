...
public class RobitspotRenderer extends ExtraLightsFixtureRenderer<RobitspotBlockEntity> {
    ...
    public void beforeRenderBeam(
            RobitspotBlockEntity blockEntity,
            PoseStack poseStack,
                ...
                public void render(MultiBufferSource.BufferSource bufferSource, PoseStack poseStack, Camera camera, float partialTick) {
                    ...
                    if (goboValue == 0) {
                        if (TheatricalExtraLightsConfig.shouldRender2DBeam()) {
                            ...
                            renderLightBeam2D(builder, poseStack, blockEntity, camera, alpha, 0.12f, (float) blockEntity.getDistance(), color, 0.007f);
                            poseStack.popPose();
                        } else {
                            poseStack.pushPose();
                            poseStack.translate(0.5f, 1.455f, -0.59f);
                            renderLightBeam4D(builder, poseStack, blockEntity, partialTick, alpha, 0.12f, (float) blockEntity.getDistance(), color, 0.007f);
                            poseStack.popPose();
                        }
                    }
                    ...
                    // LENS
                    renderLens(multiBufferSource, poseStack, alpha, color, 0.25f, 0.5f, 1.455f, -0.59f);
