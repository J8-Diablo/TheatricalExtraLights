...
public class SearchlightRenderer extends ExtraLightsFixtureRenderer<SearchlightBlockEntity> {
    ...
    public void beforeRenderBeam(
            SearchlightBlockEntity blockEntity,
            PoseStack poseStack,
                ...
                public void render(MultiBufferSource.BufferSource bufferSource, PoseStack poseStack, Camera camera, float partialTick) {
                    ...
                    if (goboValue == 0) {
                        if (TheatricalExtraLightsConfig.shouldRender2DBeam()) {
                            ...
                            renderLightBeam2D(builder, poseStack, blockEntity, camera, alpha, 0.17f, (float) blockEntity.getDistance(), color, 0.007f);
                            poseStack.popPose();
                        } else {
                            poseStack.pushPose();
                            poseStack.translate(0.5F, 1.28F, -0.265F);
                            renderLightBeam4D(builder, poseStack, blockEntity, partialTick, alpha, 0.17f, (float) blockEntity.getDistance(), color, 0.007f);
                            poseStack.popPose();
                        }
                    }
                    ...
                    // LENS
                    renderLens(multiBufferSource, poseStack, alpha, color, 0.28f, 0.5f, 1.28f, -0.265f);
