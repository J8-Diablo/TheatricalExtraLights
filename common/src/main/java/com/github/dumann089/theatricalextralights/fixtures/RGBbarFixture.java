...
public class RGBbarFixture extends Fixture {
    ...
    private static final ResourceLocation TILT_MODEL = new ResourceLocation(Theatrical.MOD_ID, "block/ledbar/ledbar_body_only");
    private static final ResourceLocation PAN_MODEL = new ResourceLocation(Theatrical.MOD_ID, "block/ledbar/ledbar_handle_only");
    private static final ResourceLocation STATIC_MODEL = new ResourceLocation(Theatrical.MOD_ID, "block/ledbar/ledbar_hook_bar");
