...
public class Moving500Renderer extends FixtureRenderer<Moving500BlockEntity> {
    ...
    @Override
    public void beforeRenderBeam(Moving500BlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
...
//            poseStack.translate(blockEntity.getFixture().getBeamStartPosition()[0], blockEntity.getFixture().getBeamStartPosition()[1], blockEntity.getFixture().getBeamStartPosition()[2]);
                    ...
                    poseStack.translate(0.5F, 0.78125F, 0.023F);
                    Matrix4f m = poseStack.last().pose();
                    Matrix3f normal = poseStack.last().normal();
                    addVertex(beamConsumer, m, normal, r, g, b, a, -0.125f, 0.125f , 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,  0.125f, 0.125f, 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a, 0.125f, -0.125f,0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,-0.125f, -0.125f, 0f);
                    poseStack.popPose();
