...
public class BigPanel2Fixture extends Fixture {
    ...
    private static final ResourceLocation TILT_MODEL = new ResourceLocation(TheatricalExtraLights.MOD_ID, "block/bigpanel2x3/bigpanel2x3_body");
    ...
    private final float[] tiltRotation = new float[]{0.0625F, .5F, 1.25F};
    private final float[] panRotation = new float[]{0.0625F, 0.5F, .5F};
    private final float[] beamStartPosition = new float[]{0.0625F, 0.5F, 0.5F};
