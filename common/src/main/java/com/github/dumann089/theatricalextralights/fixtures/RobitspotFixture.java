...
public class RobitspotFixture extends Fixture {
    ...
    private static final ResourceLocation PAN_MODEL = new ResourceLocation(TheatricalExtraLights.MOD_ID, "block/robitspot/robitspot_pan");
    private static final ResourceLocation STATIC_MODEL = new ResourceLocation(TheatricalExtraLights.MOD_ID, "block/robitspot/robitspot_static");

    private final float[] tiltRotation = new float[]{0.5F, 1.403F, .503F};
    private final float[] panRotation = new float[]{0.5F, 0.125F, .471F};
//    private final float[] beamStartPosition = new float[]{0.5F, 1.875F, 0.4375F};
    ...
    public float[] getBeamStartPosition() {
        return new float[]{0.5F, 1.45F, -0.59F};
    }
