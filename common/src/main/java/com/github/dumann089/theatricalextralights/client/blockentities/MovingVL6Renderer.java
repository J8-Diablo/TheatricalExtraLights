...
public class MovingVL6Renderer extends ExtraLightsFixtureRenderer<MovingVL6BlockEntity> {
    ...
    public void beforeRenderBeam(
            MovingVL6BlockEntity blockEntity,
            PoseStack poseStack,
        ...
        if (blockEntity.getIntensity() > 0) {
            LazyRenderers.addLazyRender(new LazyRenderers.LazyRenderer() {
                ...
                public void render(MultiBufferSource.BufferSource bufferSource, PoseStack poseStack, Camera camera, float partialTick) {
                    ...
                    renderLightBeam2D(beamConsumer, poseStack, blockEntity, camera, alpha, 0.05f, (float) blockEntity.getDistance(), color, 0.01f);
                    poseStack.popPose();
                    ...
                    poseStack.pushPose();
                    poseStack.translate(0.5F, 0.8125F, 0.02F);
                    renderLensGlow(beamConsumer, poseStack, color, 0.10f);
                    poseStack.popPose();
