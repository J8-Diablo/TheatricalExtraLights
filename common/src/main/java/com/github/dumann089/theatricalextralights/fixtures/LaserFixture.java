...
public class LaserFixture extends Fixture {
    ...
    private final float[] tiltRotation = new float[]{0.5F, 0.53F, 0.921875F};
    private final float[] panRotation = new float[]{0.5F, 0.53F, 0.921875F};
//    private final float[] beamStartPosition = new float[]{0.5F, 0.53F, 0.25F};
    ...
    public float[] getBeamStartPosition() {
        return new float[]{0.5F, 0.53F, 0.921875F};
    }
