...
public class Source4Renderer extends FixtureRenderer<Source4BlockEntity> {
...
//        poseStack.mulPose(Axis.XP.rotationDegrees(180));
    ...
    @Override
    public void beforeRenderBeam(Source4BlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
...
//            poseStack.translate(blockEntity.getFixture().getBeamStartPosition()[0], blockEntity.getFixture().getBeamStartPosition()[1], blockEntity.getFixture().getBeamStartPosition()[2]);
                    ...
                    poseStack.translate(0.5, 0.1875f, 0.122f);
                    Matrix4f m = poseStack.last().pose();
                    Matrix3f normal = poseStack.last().normal();
                    addVertex(beamConsumer, m, normal, r, g, b, a, -0.09375f, 0.09375f , 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,  0.09375f, 0.09375f, 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a, 0.09375f, -0.09375f,0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,-0.09375f, -0.09375f, 0f);
                    poseStack.popPose();
    ...
    public void preparePoseStack(Source4BlockEntity blockEntity, PoseStack poseStack, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging) {
        ...
        if(isHanging){
            ...
            poseStack.translate(0.0, -0.22, 0.0F);
        }
        //#endregion
        if(facing.getAxis() == Direction.Axis.X){
            poseStack.mulPose(Axis.YP.rotationDegrees(facing.toYRot()));
